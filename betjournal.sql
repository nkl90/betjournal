...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 25 2019 г., 11:31
...
INSERT INTO `betjournal_author` (`ID`, `Author_name`) VALUES
(1, 'Долгушин Д. В.'),
(2, 'Лущак В. А.'),
(3, 'Либас А. А.'),
(4, 'Лобыкин Ю. В.'),
...
(1, 'Новость дня', 'Новость дня ', 'Новость дня', '2019-06-27', '2019-07-21', NULL, 1),
...
(34, 'today', 'today   ', 'yesterday', '2019-07-18', '2019-07-18', 2, 4),
(36, 'g', 'h ', 'j', '2019-07-19', '2019-07-19', NULL, 2),
(47, 'o', 'ljl', 'khk', '2019-07-24', NULL, NULL, 2);
